...
((_target in (attachedObjects _unit)) && {_target getVariable [QGVAR(isHandcuffed), false]} || (_target in (attachedObjects _unit)) && {_target getVariable [QGVAR(isZiptied), false]})
